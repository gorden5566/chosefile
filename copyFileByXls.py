...
# 读取xls文件
def parseXls(filePath, columnIndex, columnTitle):
...
def main():
    ...
    properties = getConfig(configName)
    ...
    # 解析excel，提取模板名
    nameArr = parseXls(excelPath, columnIndex, columnTitle)

    # 复制文件
    for name in nameArr:
        copyfile(sourceDir, targetDir, name + extName)
